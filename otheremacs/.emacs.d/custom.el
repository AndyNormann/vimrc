...
(custom-set-faces
 ...
 '(mode-line ((t (:background "grey90" :foreground "black" :inverse-video nil :weight normal))))
 '(mode-line-inactive ((t (:inherit mode-line :background "grey89" :foreground "#969896" :inverse-video nil :box nil :weight normal))))
 ...
 '(region ((t (:background "#dddddd" :inverse-video nil))))
